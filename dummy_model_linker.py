...
D = 2  # number of dimensions of each news event
# d = sys.argv[0]
...
for i, date_count in enumerate(date_counts):
    ...
    day_series = pd.Series(date_count[last_index: last_index+date_count], name=date_string)
